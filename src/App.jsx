    ...
    tasks: {
      sop1: {
        ...
        steps: [
          ...
          { id: 's1-12', text: 'Update the Finished Ad Spreadsheet for each platform:', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' },
            branch: {
              label: 'What to fill in for each ad',
              steps: [
                { id: 's1-fas-1', text: 'Meta Ad Status → "Posted" if it worked. If there was an issue, write the specific problem (e.g. "ratio issues", "upload failed").' },
                { id: 's1-fas-2', text: 'TikTok Ad Status → "Posted" if it worked. If there was an issue, write the specific problem.' },
                { id: 's1-fas-3', text: 'Meta Added Date → today\'s date (e.g. 4/10)' },
                { id: 's1-fas-4', text: 'TikTok Added Date → today\'s date (e.g. 4/10)' },
                { id: 's1-fas-5', text: 'NEVER leave status blank. Every ad is either "Posted" or has an issue written in.' },
              ],
            } },
      ...
      sop2: {
        ...
        steps: [
          ...
          { id: 's2-5', text: 'After running on at least one platform: add row to Finished Ad Spreadsheet (next number, name with underscores, link, format). Use the same number for both platforms.', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' } },
          { id: 's2-6', text: 'Update the Finished Ad Spreadsheet for each platform:', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' },
            branch: {
              label: 'What to fill in for each ad',
              steps: [
                { id: 's2-fas-1', text: 'Meta Ad Status → "Posted" if it worked. If there was an issue, write the specific problem (e.g. "ratio issues", "upload failed").' },
                { id: 's2-fas-2', text: 'TikTok Ad Status → "Posted" if it worked. If there was an issue, write the specific problem.' },
                { id: 's2-fas-3', text: 'Meta Added Date → today\'s date (e.g. 4/10)' },
                { id: 's2-fas-4', text: 'TikTok Added Date → today\'s date (e.g. 4/10)' },
                { id: 's2-fas-5', text: 'NEVER leave status blank. Every ad is either "Posted" or has an issue written in.' },
              ],
            } },
          { id: 's2-7', text: 'Remove "To Do" from the Ad Status dropdown once BOTH platforms have been run. If either platform is still waiting (NEED / not tagged), keep "To Do" — Asher will get the codes/tags.', done: false,
            where: { label: 'Influencer Spreadsheet (Posts)', url: 'https://docs.google.com/spreadsheets/d/1-cep-71yHRc6XxdEcq9vesl3KJLUjNaSqZF3eQB7GUA/edit?gid=82550399#gid=82550399' } },
        ],
        status: 'not-started',
        notes: '',
      ...
      sop3: {
        ...
        steps: [
          ...
          { id: 's3-7', text: 'Update status from "Scheduled" to "Posted" (or write the specific issue). Fill in "Meta Added Date" and "TikTok Added Date" with today\'s date.', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' } },
...
function createAsherDay() {
  return {
    ...
    tasks: {
      gelou: {
        title: '1. Check on Gelou',
        description: 'Review her daily report, verify her work, unblock her',
        steps: [
      ...
      ads: {
        title: '2. Ads & Performance',
        description: 'Check spend, performance, and adjust budgets across all platforms',
        steps: [
          { id: 'a-ad1', text: 'Review spend, CPM, and performance of active ads', done: false,
            where: { label: 'Meta Ads', url: 'https://adsmanager.facebook.com' } },
          { id: 'a-ad2', text: 'Review spend, CPM, and performance of active ads', done: false,
            where: { label: 'TikTok Ads', url: 'https://ads.tiktok.com' } },
          { id: 'a-ad3', text: 'Pause underperforming ads and adjust budgets if needed', done: false,
            where: [
              { label: 'Meta Ads', url: 'https://adsmanager.facebook.com' },
              { label: 'TikTok Ads', url: 'https://ads.tiktok.com' },
            ] },
      ...
      creators: {
        title: '3. Creator Pipeline',
        description: 'Track creators, review posts, collect codes and tags',
        steps: [
          { id: 'a-c1', text: 'Check DMs for new creator replies or pitches', done: false,
            where: [
              { label: 'Instagram', url: 'https://instagram.com' },
              { label: 'TikTok', url: 'https://tiktok.com' },
            ] },
          { id: 'a-c2', text: 'Go through influencer CRM — check if any creators have posted new content. For each new post, add to the Posts spreadsheet: creator name, date, links, views, total views, video cost, ad status (To Do / Don\'t Run), TT Spark Code, IG Partnered + Tag.', done: false,
            where: { label: 'Influencer Spreadsheet (Posts)', url: 'https://docs.google.com/spreadsheets/d/1-cep-71yHRc6XxdEcq9vesl3KJLUjNaSqZF3eQB7GUA/edit?gid=82550399#gid=82550399' } },
          { id: 'a-c3', text: 'Review the actual posts — if necessary, write feedback for influencers on the integration', done: false,
            where: { label: 'Influencer Spreadsheet (Posts)', url: 'https://docs.google.com/spreadsheets/d/1-cep-71yHRc6XxdEcq9vesl3KJLUjNaSqZF3eQB7GUA/edit?gid=82550399#gid=82550399' } },
          { id: 'a-c4', text: 'Reach out to creators (or their influencer managers — Caleb, Thatcher) who are missing TT Spark codes or IG partnership tags. Get them into the sheet.', done: false,
            where: { label: 'Influencer Spreadsheet (Posts)', url: 'https://docs.google.com/spreadsheets/d/1-cep-71yHRc6XxdEcq9vesl3KJLUjNaSqZF3eQB7GUA/edit?gid=82550399#gid=82550399' } },
          { id: 'a-c5', text: 'Accept any pending IG collab posts', done: false,
      ...
      inhouse: {
        title: '4. In-House Content',
        description: 'Review and organize content from JP / Eliaquim, set up testimonial POPs',
        steps: [
          { id: 'a-ih1', text: 'Review and greenlight any new in-house content from JP / Eliaquim', done: false,
            where: { label: 'Ads (11/10/25-) Sheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=932862585#gid=932862585' } },
          { id: 'a-ih2', text: 'Review testimonial videos — mark ones for posting by adding "x" prefix to filename (e.g. xVideo 3.mp4)', done: false,
            where: { label: 'Ads Google Drive', url: 'https://drive.google.com/drive/folders/1GlAFM_7Rj5sj9QIB0PFEvD6KlO3qAdpc' } },
          { id: 'a-ih3', text: 'For each "x" video: add row with post name, Drive link, caption, and YouTube title', done: false,
            where: { label: 'Testimonial POP Sheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=625366125#gid=625366125' } },
        ],
        status: 'not-started',
        notes: '',
