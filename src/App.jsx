    ...
    tasks: {
      sop1: {
        ...
        steps: [
          ...
          { id: 's1-12', text: 'Update the Finished Ad Spreadsheet for each platform you posted on: set Meta/TikTok Ad Status to "Posted" if it worked. If there was an issue, write the specific problem instead (e.g. "ratio issues", "upload failed"). Also fill in "Meta Added Date" and/or "TikTok Added Date" with today\'s date. Every ad must have a status — either "Posted" or the issue. Never leave it blank.', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' } },
      ...
      sop2: {
        ...
        steps: [
          ...
          { id: 's2-5', text: 'After running on at least one platform: add row to Finished Ad Spreadsheet (next number, name with underscores, link, format). Use the same number for both platforms.', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' } },
          { id: 's2-6', text: 'For each platform: set the status to "Posted" if it worked, or write the specific issue if it didn\'t (e.g. "ratio issues", "upload failed"). Fill in "Meta Added Date" and/or "TikTok Added Date" with today\'s date. Every ad must have a status — either "Posted" or the issue. Never leave it blank.', done: false,
            where: { label: 'Finished Ad Spreadsheet', url: 'https://docs.google.com/spreadsheets/d/1cvpupZRZUG57gfN6BoZGkhE2VBq83RDaYEoUazvatOA/edit?gid=9406102#gid=9406102' } },
